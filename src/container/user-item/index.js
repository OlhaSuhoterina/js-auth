  ...
  updateView = () => {
    ...
    switch (this.status) {
      ...
      <div  class="data ">
        ...
        <span class="data-value skeleton" ></span>
      </div>  
      <div  class="data">
      ...
      <div class="data">
        <span class="data-title">Роль</span>
        <span class="data-value skeleton" ></span>
      </div>
      <div class="data">
        <span class="data-title">Пошта підтверджена?</span>
        <span class="data-value skeleton" ></span>
      </div>
      `
        break
      ...
      case this.STATE.SUCCESS:
        ...
        <div  class="data ">
          <span class="data-title">ID</span>
         <span class="data-value skeleton" >${id}</span>
        </div>  
        <div  class="data">
          <span class="data-title">E-mail</span>
          <span class="data-value skeleton">${email}</span>
        </div>  
        <div class="data">
          <span class="data-title">Роль</span>
          <span class="data-value skeleton" >${role}</span>
        </div>
        <div class="data">
          <span class="data-title">Пошта підтверджена?</span>
          <span class="data-value skeleton" >${confirm}</span>
        </div>
      `
        break
